const Header = () => {
  return (
    <div
      ...
      <a
        className="w-[40px] h-[40px] mt-2 hover:scale-125 duration-150 bg-white"
      ...
      <a
        className="w-[40px] h-[40px] hover:scale-125 duration-150 bg-white"
      ...
      <a
        className="w-[40px] h-[40px] hover:scale-125 duration-150 mb-2 bg-white"
        href="mailto:joel.sellgren@hotmail.com"
        target="_blank">
        <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4 7.00005L10.2 11.65C11.2667 12.45 12.7333 12.45 13.8 11.65L20 7" stroke="#000000" strokeWidth="2" />
